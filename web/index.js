...
__wepy_require(3).default.$createApp(_default, {"routes":{"pages/index":6,"pages/demo":14},"style":[5,13,18,24,37,38,39,41,42,52],"components":{},"apis":{}}, {"noPromiseAPI":["createSelectorQuery"]});
...
var _app = __wepy_require(26);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(27);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(28);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(29);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(30);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(31);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(32);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(33);
...
var g = __wepy_require(34);

if (!g.Promise) {
  // IOS 10.0.1 may cause IOS crash.
  g.Promise = __wepy_require(35);
}
if (!g.regeneratorRuntime) {
  g.regeneratorRuntime = __wepy_require(36);
}
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.methods = {
    ...
    counterEmit: function counterEmit() {
      ...
      console.log(this.$name + ' receive ' + $event.name + ' from ' + $event.source.$name + '   methods');
    }
  };
  this.events = {
    'index-emit': function indexEmit() {
      ...
      console.log(_this2.$name + ' receive ' + $event.name + ' from ' + $event.source.$name + '   events');
    }
  };
};
...
var _groupitem = __wepy_require(40);
...
var _timepicker = __wepy_require(15);

var _timepicker2 = _interopRequireDefault(_timepicker);

var _utils = __wepy_require(16);

var _request = __wepy_require(17);
...
var Demo = function (_wepy$page) {
  ...
  function Demo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Demo.__proto__ || Object.getPrototypeOf(Demo)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      navigationBarTitleText: 'Call Me'
    }, _this.$repeat = {}, _this.$props = { "timepicker": { "xmlns:v-on": "" } }, _this.$events = { "timepicker": { "v-on:datepicker": "receivedate" } }, _this.components = {
      //  不能使用驼峰
      panel: _panel2.default,
      toast: _wepyComToast2.default,
      ...
      submit: function submit() {
        ...
        (0, _utils.isTelephone)(this.phone) || this.toast('号码错误');
        // 广播子组件事件
      ...
      receivedate: function receivedate(e) {
        var date = e.date,
            time = e.time;
      ...
      // 父组件 page <compa v-on:copma-show='show'/>  
      // methods = {show(){}}
...
var timePicker = function (_wepy$component) {
    ...
    function timePicker() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = timePicker.__proto__ || Object.getPrototypeOf(timePicker)).call.apply(_ref, [this].concat(args))), _this), _this.props = {}, _this.data = {
            date: '年-月-日',
            time: '时:分'
        }, _this.events = {
            // 接受广播事件
            'index-showlog': function indexShowlog() {
...
function request(obj) {
  ...
  obj.url = _index2.default.HTTPPROTOCOL + _index2.default.HOST + obj.url;
...
/***** module 18 start *****/
/***** src/pages/demo.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".index {\n  background: #F8F8F8;\n  color: #666;\n  font-size: 16px;\n}\n.index .userinfo {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.index .userinfo-avatar {\n  overflow: hidden;\n  display: block;\n  width: 50px;\n  height: 50px;\n  margin: 10px;\n  margin-top: 25px;\n  border-radius: 50%;\n  border: 2px solid #fff;\n  box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.2);\n  box-sizing: border-box;\n}\n.index .phone {\n  background: #fff;\n  line-height: 40px;\n  height: 40px;\n  font-size: 14px;\n  padding-left: 5px;\n}\n.index .userinfo-nickname {\n  color: #aaa;\n}\n.index .btn-align {\n  text-align: center;\n  margin-top: 10px;\n  margin-bottom: 10px;\n}\n\n"},/***** module 18 end *****/
...
/***** module 25 start *****/
/***** src/components/timepicker.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"timePicker\">\n        <div class=\"section\">\n            <div class=\"section__title\">日期: </div>\n            <picker mode=\"date\" start=\"2018-06-01\" end=\"2100-01-01\" @change=\"bindDateChange($event)\" :value=\"(date)\">\n                <div class=\"picker\">\n                    {{date}}\n                </div>\n          </picker>\n        </div>\n        <div class=\"section\">\n            <div class=\"section__title\">时间: </div>\n            <picker mode=\"time\" start=\"\" end=\"\" @change=\"bindTimeChange($event)\" :value=\"(time)\">\n                <div class=\"picker\">\n                    {{time}}\n                </div>\n          </picker>\n        </div>\n    </div>\n"},/***** module 25 end *****/
...
var _component2 = __wepy_require(28);
...
/***** module 42 start *****/
/***** src/components/timepicker.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".timePicker .section {\n  display: flex;\n  font-size: 14px;\n  height: 40px;\n  line-height: 40px;\n  background: #fff;\n  border: 1px solid #F8F8F8;\n  padding-left: 5px;\n}\n.timePicker .section .section__title {\n  margin-right: 10px;\n}\n.timePicker .section picker {\n  flex: 1;\n}\n\n"},/***** module 42 end *****/
